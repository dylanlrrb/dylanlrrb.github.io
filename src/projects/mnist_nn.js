(({tileImage, tileTitle, markdownUrl, controls}) => {
  ...
  fetch(markdownUrl).then(res => res.text())
    ...
    controls: [
      ...
      '<a href="./demos/mnist_nn/index.html" target="_blank"><button class="primary-action-button">Demo</button></a>'
    ],
  })
