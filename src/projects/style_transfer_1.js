...
(({tileImage, tileTitle, markdownUrl, controls}) => {
  ...
  controls: [
    '<a href="https://colab.research.google.com/github/dylanlrrb/dylanlrrb.github.io/blob/master/portfolio/style_transfer_1/notebook.ipynb" target="_blank"><button class="primary-action-button">Notebook</button></a>',
  ],
})
