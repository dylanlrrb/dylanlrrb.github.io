...
l12 = layers.LeakyReLU(alpha=0.1)(layers.Conv2DTranspose(64, (3, 3), strides=(2, 2), padding='same', kernel_initializer='he_uniform', activity_regularizer=tf.keras.regularizers.l1(10e-10))(l11))
l13 = layers.LeakyReLU(alpha=0.1)(layers.Conv2D(256, (3, 3), padding='same', kernel_initializer='he_uniform', activity_regularizer=tf.keras.regularizers.l1(10e-10))(l12))
l14 = layers.LeakyReLU(alpha=0.1)(layers.Conv2D(256, (3, 3), padding='same', kernel_initializer='he_uniform', activity_regularizer=tf.keras.regularizers.l1(10e-10))(l13))

l15 = layers.add([l14, l8])

l16 = layers.LeakyReLU(alpha=0.1)(layers.Conv2DTranspose(64, (3, 3), strides=(2, 2), padding='same', kernel_initializer='he_uniform', activity_regularizer=tf.keras.regularizers.l1(10e-10))(l15))
l17 = layers.LeakyReLU(alpha=0.1)(layers.Conv2D(128, (3, 3), padding='same', kernel_initializer='he_uniform', activity_regularizer=tf.keras.regularizers.l1(10e-10))(l16))
l18 = layers.LeakyReLU(alpha=0.1)(layers.Conv2D(128, (3, 3), padding='same', kernel_initializer='he_uniform', activity_regularizer=tf.keras.regularizers.l1(10e-10))(l17))

l19 = layers.add([l18, l5])

l20 = layers.LeakyReLU(alpha=0.1)(layers.Conv2DTranspose(64, (3, 3), strides=(2, 2), padding='same', kernel_initializer='he_uniform', activity_regularizer=tf.keras.regularizers.l1(10e-10))(l19))
l21 = layers.LeakyReLU(alpha=0.1)(layers.Conv2D(64, (3, 3), padding='same', kernel_initializer='he_uniform', activity_regularizer=tf.keras.regularizers.l1(10e-10))(l20))
l22 = layers.LeakyReLU(alpha=0.1)(layers.Conv2D(64, (3, 3), padding='same', kernel_initializer='he_uniform', activity_regularizer=tf.keras.regularizers.l1(10e-10))(l21))

l23 = layers.add([l22, l2])

decoded_image = layers.LeakyReLU(alpha=0.1)(layers.Conv2D(3, (3, 3), padding='same', kernel_initializer='he_uniform', activity_regularizer=tf.keras.regularizers.l1(10e-10))(l23))
